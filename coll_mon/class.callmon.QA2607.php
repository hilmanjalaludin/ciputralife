	...
	**/
	...
	function getCustomerInfo(){
		$sql = "SELECT a.CustomerId,a.CustomerFirstName, b.CampaignName, d.ProductCode, d.ProductName,
				DATE_FORMAT(f.PolicySalesDate,'%d-%m-%Y') AS SELLINGDATE, g.id, g.Full_Name, sum(h.duration)
		...
		<table cellpadding="3px" style="margin-bottom:4px;" width="99%" border="0">
			...
			<tr>
				...
				<tr>
					...
					<td>:</td>
					<td><?php $this -> Form -> jpInput('product_name','input',$_Customer['Duration'],null,1); ?></td>
				</tr>
		...
		foreach($Category as $key => $value){
			...
			?>
				<tr class="select-rows">
					...
					<td width="1%" align="center" style="border-bottom:1px solid #dddddd;font-weight:normal;"><input class="box" name="minutes" type="text" maxlength="2" width="5px"placeholder="00"></td>
					<td style="border-bottom:1px solid #dddddd;font-weight:normal;"> : </td>
					<td width="1%" align="center" style="border-bottom:1px solid #dddddd;font-weight:normal;"><input class="box" name="second" type="text" maxlength="2" width="5px"placeholder="00"></td>
