<?php
	...
	class txtFile{
		...
		function logConsole($write_line_text,$access_dir){
			...
			//$dir_report_file = "../DownLoadReport/prospectlevel/".$access_dir."_".date('Y-m-d').".txt"; 
			$dir_report_file = "/var/www/html/cigna/DownLoadReport/prospectlevel/".$access_dir.".txt"; 
			$dir_handle_file = fopen($dir_report_file, 'w');
			//var_dump($dir_handle_file );
