<?php
class score_report extends index
{
	...
	function write_footer()
	{
		echo "	<tr>
					...
					<td class=\"total middle\" nowrap></td>
					<td class=\"total middle\" nowrap></td>
					<td class=\"total lasted\" nowrap></td>
				</tr></table> ";
	}
	...
	{ 
		// echo "<pre>";
		// print_r( self::getHeaderScore());
		// echo "</pre>";
		$header=self::getHeaderScore();
		echo "<table class=\"grid\" cellpadding=\"0\" cellspacing=\"0\" >
				<tr>
					<td rowspan=\"3\" class=\"header first\" nowrap align=\"center\">No</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">PROSPECT ID</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">PROSPECT</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">POLICY</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">CLOSING DATE</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">PAYER NAME</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">INSURED NAME</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">INSURED DOB</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">PREMIUM</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">APE</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">PRODUCT</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">CAMPAIGN</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">CASE STATUS</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">DB STATUS</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">AGENT</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">TM ID</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">SPV</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">AM</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">APPROVE / CANCEL QA DATE</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">QC</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">NO TELP</td>";
		foreach($header as $category=>$ArrValue){
				$colspan = count($header[$category])*2;
				echo "<td colspan=\"".$colspan."\"  class=\"header middle\" nowrap align=\"center\">".self::ChangeToSpace($category)."</td>";	
		}
			echo "<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">Remarks</td>
				  <td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">Total Score</td>
				  <td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">Rating</td>
				  <td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">HASIL DC</td>
				  <td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">DC By DATE</td>
				  <td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">DC OLEH</td>
				  <td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">NO. CC & EXP. CARD</td>
				  <td rowspan=\"3\" class=\"header lasted\" nowrap align=\"center\">NOTE</td>
				  <td rowspan=\"3\" class=\"header lasted\" nowrap align=\"center\">Remark 1</td>
				</tr>";
		echo "<tr>";
		foreach($header as $category=>$ArrValue){
			foreach($ArrValue as $subcategory=>$arrval){
				echo "<td colspan=\"2\"  class=\"header middle\" nowrap align=\"center\">".self::ChangeToSpace($subcategory)."</td>";
			}
		}
		echo "</tr>";
		echo "<tr>";
		foreach($header  as $category=>$ArrValue){
			foreach($ArrValue as $subcategory=>$arrval){
				foreach($arrval as $k=>$val){
					echo "<td class=\"header middle\" nowrap align=\"center\">".$val."</td>";
				}
			}
		}
		echo "</tr>";				
	...
	function getInfoCustomer(){
		$sql="	SELECT a.CustomerId,c.InsuredId,c.PremiumGroupId,e.PolicyNumber,
		DATE_FORMAT(e.PolicySalesDate, '%d-%m-%Y') AS EFFDate ,
		DATE_FORMAT(p.created_date, '%d-%m-%Y') AS QAdate ,
		a.CustomerNumber, c.InsuredFirstName, 
				...
				k.full_name AS mgr,
				#if(n.handling_type=10,n.full_name,null) as QC,
				...
				#if(t.handling_type=5,t.full_name,null) as qa_dc,
				...
				WHERE true AND c.InsuredId IS NOT NULL
			...
			foreach($qry -> result_assoc() as $rows )
			{
				...
				$data[$rows['CustomerId']][$rows['InsuredId']]['QAdate']= $rows['QAdate'];
	...
	function write_content(){
		...
		foreach ($cusinfo as $cusid => $arrValue){
			...
			foreach($arrValue as $insuredid => $arrval){
				...
				echo   "<td class=\"content middle\" nowrap>".$arrval['CustomerId']."</td>
						<td class=\"content middle\" nowrap>".$arrval['CustomerFirstName']."</td>
						<td class=\"content middle\" nowrap>".$arrval['PolicyNumber']."</td>
						<td class=\"content middle\" nowrap>".$arrval['EFFDate']."</td>
						";
				/*if($samecustid==$no){
				echo "  <td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrValue[2]['InsuredFirstName']."</td>
						<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrValue[2]['InsuredDOB']."</td>";
						//$arrValue[2]['InsuredFirstName'] cetak hanya data insure
				}*/		
				echo  "<td class=\"content middle\" nowrap>".$arrval['PayerFirstName']."</td>
						<td class=\"content middle\" nowrap>".$arrval['InsuredFirstName']."</td>
						<td class=\"content middle\" nowrap>".$arrval['InsuredDOB']."</td>
						<td class=\"content middle\" nowrap>".(int) $arrval['Premi']."</td>
						<td class=\"content middle\" nowrap>".(int) $arrval['APE']."</td>
						<td class=\"content middle\" nowrap>".$arrval['ProductName']."</td>
						<td class=\"content middle\" nowrap>".$arrval['CampaignName']."</td>
						<td class=\"content middle\" nowrap>".$arrval['hasilanalis']."</td>";
				if($samecustid==$no){		
					echo	"<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['db_status']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['TM']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['TM_ID']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['SPV']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['mgr']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['QC_Date']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['QC']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['PhoneNum']."</td>";
					foreach($this->IdScore as $category =>$arrVal){
						foreach($arrVal as $subcat => $val){
							echo "<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$answer[$cusid][$category][$subcat]['score']."</td>";
							echo "<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>&nbsp;</td>";
						}
					}
					echo   "<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".($remark[$cusid][1]?$remark[$cusid][1]:"-")."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['Overall_Score']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['Rating']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['hasilDC']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['DC_Date']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['DC_Oleh']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['CC']."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".($remark[$cusid][2]?$remark[$cusid][2]:"-")."</td>
							<td rowspan=\" ".$rowspan." \" class=\"content lasted\" nowrap>".$arrval['Remark_1']."</td>";
				}				
