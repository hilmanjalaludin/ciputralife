...
class cmp_overview extends index
{
	var $_con;
/**
...
function summaryPerfomanceByCampaign()
{
	...
	foreach( $this -> _CampaignName() as $key => $CampaignId ) 
	{
		...
		echo "<table class=\"grid\" cellpadding=\"0\" cellspacing=\"0\" width=\"90%\">
					<tr>
						<td nowrap class=\"header first\" align=\"center\">Sponsor</td>
						<td nowrap class=\"header middle\" align=\"center\">Product ID</td>
						<td nowrap class=\"header middle\" align=\"center\">Campaign Split</td>
						<td nowrap class=\"header middle\" align=\"center\">Campaign ID</td>
						<td nowrap class=\"header middle\" align=\"center\">Campaign Name</td>
						<td nowrap class=\"header middle\" align=\"center\">Start Date</td>
						<td nowrap class=\"header middle\" align=\"center\">End Date</td>
						<td nowrap class=\"header middle\" align=\"center\">Leads</td>
						<td nowrap class=\"header middle\" align=\"center\">Solicited</td>
						<td nowrap class=\"header middle\" align=\"center\">Contacts</td>
						<td nowrap class=\"header middle\" align=\"center\">Terminated Leads</td>
						<td nowrap class=\"header middle\" align=\"center\">Attempt</td>
						<td nowrap class=\"header middle\" align=\"center\">Leads Remaining</td>
						<td nowrap class=\"header middle\" align=\"center\">Hours</td>
						<td nowrap class=\"header middle\" align=\"center\">TMR's (FTE)</td>
						<td nowrap class=\"header middle\" align=\"center\">Leads Allocated per TMR</td>
						...
						<td nowrap class=\"header middle\" align=\"center\">CPH</td>
						<td nowrap class=\"header middle\" align=\"center\">SCR</td>
						<td nowrap class=\"header middle\" align=\"center\">SPH</td>
						<td nowrap class=\"header middle\" align=\"center\">ANP PH</td>
						<td nowrap class=\"header middle\" align=\"center\">ANP per TMR 	</td>
						<td nowrap class=\"header middle\" align=\"center\">Sales per TMR</td>
						<td nowrap class=\"header lasted\" align=\"center\">AARP</td>
					</tr>";
	  ...
	  **/
		...
		foreach( $SizeData as $key => $SolicitedData )
		{
			...
			$percentResponse = ROUND( (($SalesData['interest']/$DatabaseData)*100),2);
				...
				echo "<tr> 
						<td nowrap class=\"content first\" align=\"center\">ASEANINDO</td>
				...
				echo "<tr>
						<td nowrap class=\"total first\" align=\"center\" colspan=\"7\">Total</td>
