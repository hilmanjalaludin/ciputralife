	...
	{ 
		...
		echo "<table class=\"grid\" cellpadding=\"0\" cellspacing=\"0\" >
				<tr>
					...
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">EFF. DATE</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">CIF. NO</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">NAME</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">DOB</td>
					...
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">EXPORT DATE</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">STATUS</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">AGENT</td>
					<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">EFF. DATE COMPLETE</td>
		...
		foreach($header as $category=>$ArrValue){
			...
			echo "<td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">Remarks</td>
				  ...
				  <td rowspan=\"3\" class=\"header middle\" nowrap align=\"center\">HASIL ANALIS</td>
	...
	function write_content(){
		...
		foreach ($cusinfo as $cusid => $arrValue){
			...
			foreach($arrValue as $premigroupid => $arrval){
				...
				echo   "<td class=\"content middle\" nowrap>".$arrval['PolicyNumber']."</td>
						<td class=\"content middle\" nowrap>".$arrval['EFFDate']."</td>
						<td class=\"content middle\" nowrap>&nbsp;</td>";
				/*if($samecustid==$no){
				...
				echo  "<td class=\"content middle\" nowrap>".$arrval['InsuredFirstName']."</td>
				...
				if($samecustid==$no){		
					echo	"<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>&nbsp;</td>
							...
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrValue[2]['PhoneNum']."</td>";
					...
					echo   "<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".($remark[$cusid][1]?$remark[$cusid][1]:"-")."</td>
							...
							<td rowspan=\" ".$rowspan." \" class=\"content middle\" nowrap>".$arrval['hasilanalis']."</td>
							...
							<td rowspan=\" ".$rowspan." \" class=\"content lasted\" nowrap>".($remark[$cusid][2]?$remark[$cusid][2]:"-")."</td>";
				}				
