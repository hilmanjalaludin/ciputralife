<?php
	...
	//set_time_limit(500000);
		...
		$sql = 
			...
			WHERE 
				tgf.FuType 		= '1'   AND 
				tps.ApproveId 	= '14'  AND 
				tps.AproveCode 	= '510' AND 
...
<body>
	<fieldset class="corner">
		<legend class="icon-product" style="color: teal;"> &nbsp;&nbsp;&nbsp;Follow Up FA &nbsp;&nbsp;&nbsp;</legend>
