	...
	//set_time_limit(500000);
		...
		$sql = "
			SELECT DISTINCT 
				...
				WHERE tgf.FuType = 1 AND tps.ApproveId = 14 AND tps.AproveCode = '510'
...
<fieldset class="corner">
		<legend class="icon-product" style="color: teal;"> &nbsp;&nbsp;&nbsp;Follow Up FA &nbsp;&nbsp;&nbsp;</legend> <br>
		...
		<table width="99%" class="" border="1">
			<thead>
				...
				<tr>
					<th bgcolor="#3366FF" colspan="7"></th>
