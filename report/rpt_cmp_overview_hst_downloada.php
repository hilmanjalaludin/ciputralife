...
<legend class="icon-product" style="color: teal;"> &nbsp;&nbsp;&nbsp;Preview Campaign Overview History &nbsp;&nbsp;&nbsp;</legend>
	...
	?>
			...
			<tr>
				...
				<?php
					...
					// echo "</pre>";
				?>
				<td nowrap style="text-align: center" class="content-middle"><?php echo $oCases ; ?></td>
				<td nowrap style="text-align: center" class="content-middle"><?php echo formatRupiah($oANP) ; ?></td>
				<td nowrap style="text-align: center" class="content-middle"><?php echo $oContact ; ?></td>
				<td nowrap style="text-align: center" class="content-middle"><?php echo $oAttempt ; ?></td>
				<td nowrap style="text-align: center" class="content-middle"><?php echo $oNotTouch ; ?></td>
				<td nowrap style="text-align: center" class="content-middle"><?php echo $oTouch ; ?></td>
