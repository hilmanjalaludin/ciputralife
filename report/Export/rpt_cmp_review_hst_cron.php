...
function CreateReport(){
	...
	$reports = "<th> &nbsp;&nbsp;&nbsp;Report Campaign Review History <br/></th>";
	...
	// $fp = fopen(dirname(__FILE__).'/Generated/Report_CampaignReview_History_'.$Reporttype.'_'.date("Ymd").'.xls', "w");
	$fp = fopen('/opt/enigma/webapps/ciputralife/report/Generated/Report_CampaignReviewHistory_'.$Reporttype.'_'.date("Ymd").'.xls', "w");
