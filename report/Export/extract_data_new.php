...
$fileName = 'EXTRACT_MTD_NEW_'.date("Ymd");
$judul = 'MTD NEW '.date("Ymd");
...
function get_data() {
	...
	$sql = "SELECT 
		...
		--concat(p.PayerAddressLine1,p.PayerAddressLine2,p.PayerAddressLine3,p.PayerAddressLine4) as ADDRESS,
		...
		where cs.CustomerUploadedTs >= '".$start_date."'
		and cs.CustomerUploadedTs <= '".$end_date."'
		and cs.CampaignId not in (1,2,3,19,22,23,24,25,26,27,28,29,30,44,64,65,89,101,105,131,132,177,20,21,33,34,35,36,37,38)
		and ( cs.CallReasonId = 0 or cs.CallReasonId is null)
		-- limit 100 
		";
