<?php
	...
	// usage:
	// php /opt/enigma/webapps/ciputralife/report/Export/rpt_cmp_review_rawactive_hst2_cron.php MTD
	// php /opt/enigma/webapps/ciputralife/report/Export/rpt_cmp_review_rawactive_hst2_cron.php tgl 2017-12-22 2017-12-22
...
function CreateReport(){
	...
	$objWriter->save("/opt/enigma/webapps/ciputralife/report/Generated/RAWData_CampaignActive2_".$reporttype."-".date('Ymd').".xlsx");
