...
class performance_by_hour extends IndexExcel
{
	var $_con;
 ...
 */
 ...
 {
	$this -> _xfn = 'REPORT_PERFORMANCE_BY_HOUR';
	$this -> _con = null;
}
     ...
     **/	 
		...
		echo "<table border=0 cellpadding=0 cellspacing=0 width='100%' style='border-collapse:collapse;> 
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					<td nowrap class=xl602508 align=\"center\">Daily Average<br>Period</td>
					...
					<td nowrap class=xl602508 align=\"center\">Contact<br>Rate %</td>
					<td nowrap class=xl602508 align=\"center\">Contact per<br>Hour</td>
					<td nowrap class=xl602508 align=\"center\">Sales Close<br>Rate % </td>
					<td nowrap class=xl602508 align=\"center\">Sales per<br>Hour</td>
					<td nowrap class=xl602508 align=\"center\">Sales per<br>Contact</td>
					<td nowrap class=xl602508 align=\"center\">Sales</td>
			...
			for( $s_i=7; $s_i<=21; $s_i++)
			{
				...
				echo "<tr class=xl592508 height=26 style='mso-height-source:userset;height:22.0pt'> 
						<td height=26 class=xl582508 style='height:22.0pt;border-top:none'  nowrap>".$s_h.":00 - ".$s_h.":59</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Utilize[$s_i]?$Utilize[$s_i]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($FreqCall[$s_i]?$FreqCall[$s_i]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Contact[$s_i]?$Contact[$s_i]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".$avg_contact." %</td> 
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($contact_hours?$contact_hours:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($percent_sales?$percent_sales:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($sale_hours?$sale_hours:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_sales?$avg_sales:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesData[$s_i]?$SalesData[$s_i]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AnpPremi[$s_i]?formatRupiah($AnpPremi[$s_i]):0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($TotLoginHour[$s_i]?toDuration($TotLoginHour[$s_i]):0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($TotBusy[$s_i]?toDuration($TotBusy[$s_i]):0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($TotReady[$s_i]?toDuration($TotReady[$s_i]):0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($TotNotReady[$s_i]?toDuration($TotNotReady[$s_i]):'0')."</td>
					</tr> ";
				}	
					
			echo "<tr class=xl152508 height=32 style='mso-height-source:userset;height:24.0pt' >
					<td nowrap nowrap class=xl602508 style='border-top:none;border-left:yes'  align=\"right\" colspan=\"15\">&nbsp;</td>
				</tr> ";
		}
