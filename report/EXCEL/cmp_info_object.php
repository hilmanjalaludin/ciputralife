...
<?php
class cmp_info_object extends IndexExcel
{
 ...
 **/
 ...
 public function show_content_excel()
	{
		mysql::__construct();
		$this -> _Excel($this -> _xfn ); //$this -> _xfn 
		$this -> _Excel_Header();
...
function  _summaryReviewByCampaign()
{
	 ...
	 **/	
		echo "<table border=0 cellpadding=0 cellspacing=0 width='100%' style='border-collapse:collapse;> 
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					<td rowspan='2' nowrap class=xl602508 align=\"center\">Campaign Name</td>
					<td colspan='20' nowrap class=xl602508 align=\"center\">Contact Performance</td>
					<td colspan='8' nowrap class=xl602508 align=\"center\">Sales & Metrics</td>
					<td colspan='6' nowrap class=xl602508 align=\"center\">Agents & Hours</td>
				</tr>
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					<td nowrap class=xl602508 align=\"center\">Database</td>
					<td nowrap class=xl602508 align=\"center\">Solicited</td>
					<td nowrap class=xl602508 align=\"center\">Solicited Rate %</td>
					<td nowrap class=xl602508 align=\"center\">Attempt</td>
					<td nowrap class=xl602508 align=\"center\">Attempt Ratio</td>
					<td nowrap class=xl602508 align=\"center\">Attempt per Complete</td>
					<td nowrap class=xl602508 align=\"center\">Attempt per Contact</td>
					<td nowrap class=xl602508 align=\"center\">Atempt per Hour</td>
					<td nowrap class=xl602508 align=\"center\">Completes</td>
					<td nowrap class=xl602508 align=\"center\">Completes Penetration %</td>
					<td nowrap class=xl602508 align=\"center\">Completes per Hour</td>
					<td nowrap class=xl602508 align=\"center\">Callbacks</td>
					<td nowrap class=xl602508 align=\"center\">Callbacks per Hour</td>
					<td nowrap class=xl602508 align=\"center\">Callbacks Left %</td>
					<td nowrap class=xl602508 align=\"center\">Contact</td>
					<td nowrap class=xl602508 align=\"center\">Contacts per Complete %</td>
					<td nowrap class=xl602508 align=\"center\">Contact per Hour</td>
					<td nowrap class=xl602508 align=\"center\">Not Interest</td>
					<td nowrap class=xl602508 align=\"center\">Miss Customers</td>
					<td nowrap class=xl602508 align=\"center\">NPU</td>
					<td nowrap class=xl602508 align=\"center\">PIF</td>
					<td nowrap class=xl602508 align=\"center\">AARP</td>
					...
					<td nowrap class=xl602508 align=\"center\">Log In Hours</td>
					<td nowrap class=xl602508 align=\"center\">Agents</td>
					<td nowrap class=xl602508 align=\"center\">Average Worked Hours</td>
					<td nowrap class=xl602508 align=\"center\">Talk Time %</td>
					<td nowrap class=xl602508 align=\"center\">Wait Time %</td>
					<td nowrap class=xl602508 align=\"center\">Wrap Time %</td>
				</tr>";
	 ...
	 **/
		...
		echo "<tr class=xl592508 height=26 style='mso-height-source:userset;height:22.0pt'>
				<td height=26 class=xl582508 style='height:22.0pt;border-top:none'  nowrap>&nbsp;".($CampaignName?$CampaignName:'')."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($DataSize[$s_d]?$DataSize[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($totSolicited[$s_d]?$totSolicited[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($PercentUtilize?$PercentUtilize:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($size_atempt[$s_d]?$size_atempt[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioAtempt?$RatioAtempt:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AttemptPerComplete?$AttemptPerComplete:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AttemptPerContact?$AttemptPerContact:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AtemptPerHour?$AtemptPerHour:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Complete[$s_d]?$Complete[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgPresentation?$AvgPresentation:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CompletePerHour?$CompletePerHour:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallBack[$s_d]?$CallBack[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallbacksPerHour?$CallbacksPerHour:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallbackLeft?$CallbackLeft:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SizeContact[$s_d]?$SizeContact[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ContactPerComplete?$ContactPerComplete:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ContactPerHour?$ContactPerHour:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($NotInterest[$s_d]?$NotInterest[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Misscustomers[$s_d]?$Misscustomers[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($NoPickUp[$s_d]?$NoPickUp[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($size_pif[$s_d]?$size_pif[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($AARP?$AARP:0))."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($size_anp[$s_d]?$size_anp[$s_d]:0))."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgPremi)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ContactRate?$ContactRate:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesClose?$SalesClose:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ResponseRate?$ResponseRate:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesPerHour?$SalesPerHour:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($TotalAgentLogin?toDuration($TotalAgentLogin):0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Agents[$s_d]?$Agents[$s_d]:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_worked?$avg_agent_worked:0)."</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_busy?$avg_agent_busy:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_ready?$avg_agent_ready:0)." %</td>
				<td nowrap class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_notready?$avg_agent_notready:0)." %</td>
			</tr>";
		...
		echo "<tr  class=xl152508 height=32 style='mso-height-source:userset;height:24.0pt'>
				<td nowrap class=xl602508 style='border-top:none;border-left:yes' align=\"center\">MTD</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_datasize?$total_datasize:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_solicited?$total_solicited:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_call_utilize?$avg_call_utilize:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_atempt?$total_atempt:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_call_atempt?$avg_call_atempt:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_attempt_complete?$avg_attempt_complete:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_attempt_contact?$avg_attempt_contact:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_AtemptPerHour?$avg_AtemptPerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_complete?$total_complete:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_complete_penetrate?$avg_complete_penetrate:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_CompletePerHour?$avg_CompletePerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_callback?$total_callback:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_CallbacksPerHour?$avg_CallbacksPerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_callback_left?$avg_callback_left:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_contact?$total_contact:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_contact_complete?$avg_contact_complete:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_ContactPerHour?$avg_ContactPerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_not_interest?$total_not_interest:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_miss_cust?$total_miss_cust:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_npu?$total_npu:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_pif?$total_pif:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($avg_aarp?$avg_aarp:0))."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($total_anp?$total_anp:0))."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($avg_premium?$avg_premium:0))."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_call_contact?$avg_call_contact:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_sales_close?$avg_sales_close:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_response?$avg_response:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_SalesPerHour?$avg_SalesPerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_login_hours?toDuration($total_login_hours):0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_agent?$total_agent:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_tots_agent_worked?$avg_tots_agent_worked:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_tots_agent_busy?$avg_tots_agent_busy:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_tots_agent_ready?$avg_tots_agent_ready:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_tots_agent_notready?$avg_tots_agent_notready:0)." %</td>
				</tr>";	 
	...
	foreach( $this -> _CampaignName() as $key => $CampaignId ) 
	{
		...
		echo "<h4>{$_conts -> result_get_value('CampaignName')}</h4>
			 <table border=0 cellpadding=0 cellspacing=0 width='100%' style='border-collapse:collapse;> 
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					<td rowspan='2' nowrap class=xl602508  align=\"center\">Weekly</td>
					<td colspan='20' nowrap class=xl602508  align=\"center\">Contact Performance</td>
					<td colspan='8' nowrap class=xl602508  align=\"center\">Sales & Metrics</td>
					<td colspan='6' nowrap class=xl602508  align=\"center\">Agents & Hours</td>
				</tr>
	 ...
	 */	
	 ...
	 foreach( self::_Weekly_List() as $k => $s_d ) 
	 {
		...
		**/
		...
		echo "<tr class=xl152508 height=32 style='mso-height-source:userset;height:24.0pt'>
				<td class=xl602508 style='border-top:none;border-left:yes' align=\"center\">MTD</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none'  align=\"right\">".($total_datasize?$total_datasize:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_solicited?$total_solicited:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_call_utilize?$avg_call_utilize:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_atempt?$total_atempt:0)."</td>
...
function _dailyReviewByCampaign()
{
	...
	{
		$_conts = $this -> _query_campaign($CampaignId);
		echo "<h4 class='xh3'>{$_conts -> result_get_value('CampaignName')}</h4>
			  <table border=0 cellpadding=0 cellspacing=0 width='100%' style='border-collapse:collapse;> 
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					<td rowspan='2' class=xl602508 rowspan=\"2\" nowrap >Date</td>
					<td colspan='20'class=xl602508 nowrap >Contact Performance</td>
					<td colspan='8' class=xl602508 nowrap >Sales & Metrics</td>
					<td colspan='6' class=xl602508 nowrap >Agents & Hours</td>
				</tr>
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					<td nowrap class=xl602508 align=\"center\">Database</td>
					<td nowrap class=xl602508 align=\"center\">Solicited</td>
	 ...
	 */	
	 ...
	 while(true)
	 {
		...
		$color 				= ($this -> __week_days($s_d)?'#dddeee':'');
				...
				echo "<tr class=xl592508 height=26 style='mso-height-source:userset;height:22.0pt'>
						<td  height=26 class=xl582508 style='height:22.0pt;border-top:none'  nowrap>".$this -> formatDateId($s_d)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($DataSize?$DataSize:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($totSolicited[$s_d]?$totSolicited[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($PercentUtilize?$PercentUtilize:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($size_atempt[$s_d]?$size_atempt[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioAtempt?$RatioAtempt:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AttemptPerComplete?$AttemptPerComplete:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AttemptPerContact?$AttemptPerContact:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AtemptPerHour?$AtemptPerHour:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Complete[$s_d]?$Complete[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgPresentation?$AvgPresentation:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CompletePerHour?$CompletePerHour:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallBack[$s_d]?$CallBack[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallbacksPerHour?$CallbacksPerHour:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallbackLeft?$CallbackLeft:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SizeContact[$s_d]?$SizeContact[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ContactPerComplete?$ContactPerComplete:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ContactPerHour?$ContactPerHour:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($NotInterest[$s_d]?$NotInterest[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Misscustomers[$s_d]?$Misscustomers[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($NoPickUp[$s_d]?$NoPickUp[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($size_pif[$s_d]?$size_pif[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AARP?formatRupiah($AARP):0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($size_anp[$s_d]?formatRupiah($size_anp[$s_d]):0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah($AvgPremi)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ContactRate?$ContactRate:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesClose?$SalesClose:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($ResponseRate?$ResponseRate:0)." %</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesPerHour?$SalesPerHour:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".(toDuration($TotLoginHour[$s_d])?toDuration($TotLoginHour[$s_d]):0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Agents[$s_d]?$Agents[$s_d]:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_worked?$avg_agent_worked:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_busy?$avg_agent_busy:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_ready?$avg_agent_ready:0)."</td>
						<td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($avg_agent_notready?$avg_agent_notready:0)."</td>
				  </tr>";
	...
	/** distinct process ***/
		...
		**/
		...
		echo "<tr class=xl152508 height=32 style='mso-height-source:userset;height:24.0pt'>
				<td nowrap class=xl602508 style='border-top:none;border-left:yes' align=\"left\">MTD</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['DataSize']?$DataSizeUtil[$CampaignId]['DataSize']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['totSolicited']?$DataSizeUtil[$CampaignId]['totSolicited']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_call_utilize?$avg_call_utilize:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_atempt?$total_atempt:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_call_atempt?$avg_call_atempt:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_attempt_complete?$avg_attempt_complete:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_attempt_contact?$avg_attempt_contact:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_AtemptPerHour?$avg_AtemptPerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['Complete']?$DataSizeUtil[$CampaignId]['Complete']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_complete_penetrate?$avg_complete_penetrate:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_CompletePerHour?$avg_CompletePerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['CallBack']?$DataSizeUtil[$CampaignId]['CallBack']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_CallbacksPerHour?$avg_CallbacksPerHour:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_callback_left?$avg_callback_left:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['SizeContact']?$DataSizeUtil[$CampaignId]['SizeContact']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_contact_complete?$avg_contact_complete:0)." %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($avg_ContactPerHour?$avg_ContactPerHour:0)."</td>
				
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['NotInterest']?$DataSizeUtil[$CampaignId]['NotInterest']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['Misscustomers']?$DataSizeUtil[$CampaignId]['Misscustomers']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($DataSizeUtil[$CampaignId]['NoPickUp']?$DataSizeUtil[$CampaignId]['NoPickUp']:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".($total_pif?$total_pif:0)."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($avg_aarp?$avg_aarp:0))."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($total_anp?$total_anp:0))."</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah(($avg_premium?$avg_premium:0))."</td>
