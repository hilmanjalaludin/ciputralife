...
class cmp_review extends IndexExcel
{
 ...
 */
 ...
 {
	$this -> _con  = null;
	$this -> _xfn  = 'REPORT_CAMPAIGN_REVIEW';
 ...
 **/
 ...
 {
	mysql::__construct(); // get all atrribut file
	$this -> _Excel( $this -> _xfn ); // get filename 
	switch( $this -> _grp )
	{
...
function  _summaryReviewByCampaign()
{
	 ...
	 **/	
		...
		echo "<table border=0 cellpadding=0 cellspacing=0 width='100%' style='border-collapse:collapse;> 
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					<td class=xl602508 rowspan=\"2\" nowrap >Campaign Name</td>
					<td class=xl602508 colspan=\"29\" nowrap align=\"center\">Campaign Review</td>
				</tr>
				<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
					...
					<td nowrap class=xl602508 align=\"center\">Connect</td>
					<td nowrap class=xl602508 align=\"center\">Connect rate %</td>
					...
					<td nowrap class=xl602508 align=\"center\">Not Completes</td>
					<td nowrap class=xl602508 align=\"center\">Answer Machines</td>
					<td nowrap class=xl602508 align=\"center\">Answer Machines %</td>
					<td nowrap class=xl602508 align=\"center\">NPU</td>
					<td nowrap class=xl602508 align=\"center\">NPU %</td>
					<td nowrap class=xl602508 align=\"center\">Abandons</td>
					<td nowrap class=xl602508 align=\"center\">Abandons %</td>
					...
					<td nowrap class=xl602508 align=\"center\">Miss Customers %</td>
					<td nowrap class=xl602508 align=\"center\">SIT</td>
					<td nowrap class=xl602508 align=\"center\">SIT Rate</td>
					<td nowrap class=xl602508 align=\"center\">Agents</td>
					<td nowrap class=xl602508 align=\"center\">Average<br>Call Length<br> - Interest</td>
					<td nowrap class=xl602508 align=\"center\">Average<br>Call Length<br> - Not Interest</td>
					<td nowrap class=xl602508 align=\"center\">Average<br>Call Length<br> - Callback</td>
					<td nowrap class=xl602508 align=\"center\">Average<br>Call Length<br> - Answer Machines</td>
					<td nowrap class=xl602508 align=\"center\">Average<br>Call Length<br> - Wait</td>
				</tr>";
	 ...
	 */	
	 ...
	 $totAvgInterestTime  =0;
	 $totAvgNotInterestTime =0;
	 $totAvgCallBackTime = 0;
	 $totAvgMachineTime  = 0;
	...
	{	
		...
		echo "<tr class=xl592508 height=26 style='mso-height-source:userset;height:22.0pt'>
				 ...
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($DataSize[$s_d]?$DataSize[$s_d]:0)."</td>
				 ...
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallIniated[$s_d]?$CallIniated[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioConnect?$RatioConnect:0)."  %</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SizeContact[$s_d]?$SizeContact[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioContact?$RatioContact:0)."  %</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Complete[$s_d]?$Complete[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($NotComplete[$s_d]?$NotComplete[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AnswerMachine[$s_d]?$AnswerMachine[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioAnswerMachine?$RatioAnswerMachine:0)."  %</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($NoPickUp[$s_d]?$NoPickUp[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioNoPickUp?$RatioNoPickUp:0)." %</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Abadone[$s_d]?$Abadone[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RationAbadone?$RationAbadone:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($CallBack[$s_d]?$CallBack[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioCallBack?$RatioCallBack:0)." %</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Misscustomers[$s_d]?$Misscustomers[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioMisscustomer?$RatioMisscustomer:0)." %</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Interest[$s_d]?$Interest[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($RatioSIT?$RatioSIT:0)." %</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($Agents[$s_d]?$Agents[$s_d]:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgInterestTime?$AvgInterestTime:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgNotInterestTime?$AvgNotInterestTime:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgCallBackTime?$AvgCallBackTime:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgMachineTime?$AvgMachineTime:0)."</td>
				 <td class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($AvgWaitTime?$AvgWaitTime:0)."</td>
			 </tr>";
			...
			$totAvgInterestTime += $Interest_time[$s_d]; 
			$totAvgNotInterestTime+= $NotInterest_time[$s_d]; 
			$totAvgCallBackTime+=$Callback_time[$s_d]; 
			$totAvgMachineTime +=$Machine_time[$s_d]; 
		 ...
		 **/
			...
			$AvgInterestTime    = ROUND((self::_Duration($totAvgInterestTime)/$total_interest),2);
			$AvgNotInterestTime = ROUND((self::_Duration($totAvgNotInterestTime)/$total_not_interest),2);
			$AvgCallBackTime    = ROUND((self::_Duration($totAvgCallBackTime)/$total_callback),2);
			$AvgMachineTime     = ROUND((self::_Duration($totAvgMachineTime)/$total_machine),2);
			$AvgWaitTime     	= 0.0;
			
				
		echo "<tr  class=xl152508 height=32 style='mso-height-source:userset;height:24.0pt' >
				<td nowrap class=xl602508 style='border-top:none;border-left:yes' align=\"left\">Summary</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_data_size}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_solicited}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_utilize} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_atempt}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_atempt}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_call_iniated}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_iniated} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_contact}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_contact} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_complete}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_complete} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_machine}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_machine} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_nopickup}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_pickup} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">0</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">0</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_callback}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_callback} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_miss_customers}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_missed}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_interest}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$avg_call_interest} %</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$total_agents}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$AvgInterestTime}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$AvgNotInterestTime}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$AvgCallBackTime}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$AvgMachineTime}</td>
				<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">{$AvgWaitTime}</td>
			</tr> ";
  ...
  foreach( $this -> _CampaignName() as $key => $CampaignId ) 
  {
	 ...
	 */	
	 ...
	 foreach( self::_Weekly_List() as $k => $s_d ) 
	 {
		...
		echo "<tr class=xl592508 height=26 style='mso-height-source:userset;height:22.0pt'>
				 <td height=26 class=xl582508 style='height:22.0pt;border-top:none'  nowrap>Week ".($s_d+1)."</td>
			...
			echo "<tr class=xl152508 height=32 style='mso-height-source:userset;height:24.0pt' >
					<td nowrap nowrap class=xl602508 style='border-top:none;border-left:yes'  align=\"right\" colspan=\"30\">&nbsp;</td>
				  </tr> ";
	}
	 ...
	 */	
	 ...
	 while(true)
	 {
		...
		echo "<tr class=xl592508 height=26 style='mso-height-source:userset;height:22.0pt'>
				...
				<td class=xl582508 style='border-top:none;border-left:none'>".($DataSize?$DataSize:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($totSolicited[$s_d]?$totSolicited[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($PercentUtilize?$PercentUtilize:0)." %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($size_atempt[$s_d]?$size_atempt[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioAtempt?$RatioAtempt:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($CallIniated[$s_d]?$CallIniated[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioConnect?$RatioConnect:0)."  %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($SizeContact[$s_d]?$SizeContact[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioContact?$RatioContact:0)."  %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($Complete[$s_d]?$Complete[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($NotComplete[$s_d]?$NotComplete[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($AnswerMachine[$s_d]?$AnswerMachine[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioAnswerMachine?$RatioAnswerMachine:0)."  %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($NoPickUp[$s_d]?$NoPickUp[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioNoPickUp?$RatioNoPickUp:0)." %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($Abadone[$s_d]?$Abadone[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RationAbadone?$RationAbadone:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($CallBack[$s_d]?$CallBack[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioCallBack?$RatioCallBack:0)." %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($Misscustomers[$s_d]?$Misscustomers[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioMisscustomer?$RatioMisscustomer:0)." %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($Interest[$s_d]?$Interest[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($RatioSIT?$RatioSIT:0)." %</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($Agents[$s_d]?$Agents[$s_d]:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($AvgInterestTime?$AvgInterestTime:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($AvgNotInterestTime?$AvgNotInterestTime:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($AvgCallBackTime?$AvgCallBackTime:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($AvgMachineTime?$AvgMachineTime:0)."</td>
				<td class=xl582508 style='border-top:none;border-left:none'>".($AvgWaitTime?$AvgWaitTime:0)."</td>
			</tr>";
