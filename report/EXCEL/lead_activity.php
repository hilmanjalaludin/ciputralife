...
class lead_activity extends IndexExcel
{
	var $_con;
	var $_xfn;
 ...
 */
 ...
 {
		$this -> _con = null;
		$this -> _xfn = 'REPORT_LEAD_ACTIVITY';
 }
		...
		echo "<h4>{$_conts -> result_get_value('CampaignName')}</h4>
				<table border=0 cellpadding=0 cellspacing=0 width='100%' style='border-collapse:collapse;' align='center'> 
					<tr class=xl152508 style='mso-height-source:userset;height:27.0pt'>
						<td nowrap class=xl602508 align=\"center\">Number of <br>Attempt<br>(per Prospect)</td>
		...
		**/
		...
		$SalesData = self::_lead_sale($CampaignId,$key);
			...
			echo "<tr class=xl592508 height=26 style='mso-height-source:userset;height:22.0pt'>
					<td height=26 class=xl582508 style='height:22.0pt;border-top:none'  align=\"right\" nowrap >".$key."</td>
					<td class=xl582508 class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($DatabaseData?$DatabaseData:0)."</td>
					<td class=xl582508 class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesData['contact']?$SalesData['contact']:0)."</td>
					<td class=xl582508 class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesData['interest']?$SalesData['interest']:0)." &nbsp;</td>
					<td class=xl582508 class=xl582508 style='border-top:none;border-left:none' align=\"right\">".($SalesData['anp']?formatRupiah($SalesData['anp']):0)." &nbsp;</td> 
					<td class=xl582508 class=xl582508 style='border-top:none;border-left:none' align=\"right\">".$percentContactRate." %</td>
					<td class=xl582508 class=xl582508 style='border-top:none;border-left:none' align=\"right\">".$percentSalesClose." %</td>
					<td class=xl582508 class=xl582508 style='border-top:none;border-left:none' align=\"right\">".$percentResponse." %</td>
					</tr>";
			...
			echo "<tr  class=xl152508 height=32 style='mso-height-source:userset;height:24.0pt' >
					<td nowrap class=xl602508 style='border-top:none;border-left:yes' align=\"right\">Total</td>
					<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".$kalDatabase."</td>
					<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".$kalContact."</td>
					<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".$kalPIF."</td>
					<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".formatRupiah($kalANP,2)."</td>
					<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".$kalPercentContactRate." %</td>
					<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".$kalPercentSalesClose." %</td>
					<td nowrap class=xl602508 style='border-top:none;border-left:none' align=\"right\">".$kalPercentResponse." %</td>
				</tr> ";
			$this -> _Excel_Footer();	
		}
