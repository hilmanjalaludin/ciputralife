...
<legend style="color: #3366FF;"> &nbsp;&nbsp;&nbsp;Preview RCT (Per Campaign)&nbsp;&nbsp;&nbsp;</legend>
...
<thead>
	...
	<tr>
					<tr>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="5" nowrap>No</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="5" nowrap>Campaign ID</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="5" nowrap>Campaign Name</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="5" nowrap>Date Upload</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="3" colspan="5" nowrap>Database</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="14" nowrap >Solicited Result</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="14" nowrap >Contacted Result</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="58" nowrap >Presentation Result</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="12" rowspan="2" nowrap >Sales Result</th>
					</tr>
					<tr>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="4" rowspan="2" nowrap>Not Connect</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" rowspan="3" nowrap>Connected (Total)</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="6" rowspan="2" nowrap>Not Contact</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" rowspan="3" nowrap>Contacted (Total)</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="14" rowspan="2" nowrap>Unable To do Presentatation</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" rowspan="3" nowrap>Done Presentation (Total)</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="26" nowrap>Customer Response</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="30" rowspan="2" nowrap>Not Interested Reasons</th>
					</tr>
					<tr>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="4" nowrap ></th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="4" nowrap>Interested ( PIF )Agent</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="4" nowrap>Interested ( PIF )Verified QA</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="4" nowrap>Interested ( PIF )Suspend Data QA</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="4" nowrap>Interested ( PIF )Suspend Selling QA</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="4" nowrap>Interested ( PIF )Rejected QA</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="2" colspan="2" nowrap>Not Interested</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="3" nowrap >RR %</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="3" nowrap>SCR %</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="2" colspan="2" nowrap>Agent</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="2" colspan="2" nowrap>Verified</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="2" colspan="2" nowrap>Suspend Data</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="2" colspan="2" nowrap>Suspend Selling</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" rowspan="2" colspan="2" nowrap>Rejected</th>
					</tr>
					<tr>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" nowrap >Supply</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap>Solicited</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Call Attempted</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" colspan="2" nowrap >fax</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Invalid Phone</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Busy Line</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >NPU</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Miss Cust</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >RUF</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >CBL</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Overage</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Already Moved</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Supplement</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Double Call</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Country Side</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Thinking</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Thinking Add New Number</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Holder</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="1" nowrap >Spouse</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="1" nowrap >Dependant</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Holder</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="1" nowrap >Spouse</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="1" nowrap >Dependant</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Holder</th>
					...
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="1" nowrap >Spouse</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="1" nowrap >Dependant</th>
					<!--<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Not Interested</th>-->
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Already had CIGNA</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >No Need Insurance</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Account Closed</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Owner Changed</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Already Insured With Compatitor</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Premium Too High</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >No Dependant</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Need High Benefit</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Premium Include Installment</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Asking Invesment Product</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Interest But No Credit Card</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Interest But Payment Mechanism Issue</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Interest But Credit Card Has Been Expired</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Interest But Card Not Received Yet</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" colspan="2" nowrap >Not Interested Other</th>
					</tr>
					<tr>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>Total</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>Total</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>%</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>Total</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>Ratio</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>Total</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>%</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>Total</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>%</th>
					...
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>Total</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap>%</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap >ANP</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap >Av Premium</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap >ANP</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap >Av Premium</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap >ANP</th>
					<th class="head" bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" align="center" width="5%" nowrap >Av Premium</th>
...
<tbody>
	...
	?>
	<tr>
	<td bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-first" colspan="4"><?php echo "T O T A L"; ?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_cmprow_count);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_slc_count);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_slc_count/$Tots_cmprow_count)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_attempt_count);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_attempt_count/$Tots_slc_count),2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_fax?$Tots_fax:0);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_fax/$Tots_slc_count)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_invalid?$Tots_invalid:0);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_invalid/$Tots_slc_count)*100,2);?></td>
	<!--connected>-->
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_slc_count-$Tots_fax-$Tots_invalid);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format((($Tots_slc_count-$Tots_fax-$Tots_invalid)/$Tots_slc_count)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_busy?$Tots_busy:0);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_busy/$Tots_slc_count)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_npu);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_npu/$Tots_slc_count)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_misscust);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_misscust/$Tots_slc_count)*100,2);?></td>
	<!--contacted>-->
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format((($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust)/$Tots_slc_count)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_ruf);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format($Tots_ruf/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_cbl);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_cbl/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_ovg);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format($Tots_ovg/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust)*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_alreadymoved);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_alreadymoved/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_supplement);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_supplement/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_doublecall);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_doublecall/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_countryside);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_countryside/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust))*100,2);?></td>
	<!--done presentation>-->
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format((($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside)/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_thingking);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_thingking/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_thingkingaddnew);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_thingkingaddnew/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_holder);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_holder/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_sp);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_dp);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_holderv);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_holderv/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_spv);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_dpv);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_holdersd);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_holdersd/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_spsd);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_dpsd);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_holderss);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_holderss/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_spss);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_dpss);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_holderr);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_holderr/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_spr);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format($Tots_dpr);?></td>
	<!--not int>-->
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder);?></td>
	...
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_alreadycigna);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_alreadycigna/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_noneedinsurance);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_noneedinsurance/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_accountclose);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_accountclose/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_ownerchange);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_ownerchange/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_alreadycompatitor);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_alreadycompatitor/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_premiumtoohigh);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_premiumtoohigh/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_nodependant);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_nodependant/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_needhighbenefit);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_needhighbenefit/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_premiumincludeins);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_premiumincludeins/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_askinginvestment);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_askinginvestment/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_intbutnocc);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_intbutnocc/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_intbutpayissue);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_intbutpayissue/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_intbutccexp);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_intbutccexp/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_intbutccnotrcv);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_intbutccnotrcv/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo ($Tots_notint);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_notint/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust-$Tots_ruf-$Tots_cbl-$Tots_ovg-$Tots_alreadymoved-$Tots_supplement-$Tots_doublecall-$Tots_countryside-$Tots_thingking-$Tots_thingkingaddnew-$Tots_holder))*100,2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format((($Tots_holder/$Tots_slc_count)*100),2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format((($Tots_holder/($Tots_slc_count-$Tots_fax-$Tots_invalid-$Tots_busy-$Tots_npu-$Tots_misscust))*100),2);?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo $Tots_anp;?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_anp/$Tots_holder/12),0,'.','');?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo $Tots_anpv;?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_anpv/$Tots_holderv/12),0,'.','');?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo $Tots_anpsd;?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_anpsd/$Tots_holdersd/12),0,'.','');?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo $Tots_anpss;?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_anpss/$Tots_holderss/12),0,'.','');?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo $Tots_anpr;?></td>
	<td nowrap bgcolor="#3366FF" style="color:#FFFFFF;text-align:center;" class="content-middle"><?php echo number_format(($Tots_anpr/$Tots_holderr/12),0,'.','');?></td>
