<?php
	...
	$sql = "SELECT a.CallReasonId,b.CallReasonCode,c.CampaignId,
			...
			WHERE 1=1
			AND a.CustomerUpdatedTs >= '".$_REQUEST['start_date']." 00:00:00' 
			AND a.CustomerUpdatedTs <= '".$_REQUEST['end_date']." 23:00:00'
			";
		if($_REQUEST['cmp']){
			$sql.=" AND c.CampaignId In (".$campaign1.")";
		}
	...
	echo "<th> &nbsp;&nbsp;&nbsp;Report Campaign Review <br/></th>";
