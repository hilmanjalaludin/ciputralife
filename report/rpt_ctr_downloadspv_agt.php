...
//
	...
	function asgn(){
		...
		$sql.=$whr. " GROUP BY spv.id ";
				...
				WHERE date(cst.CustomerUploadedTs) BETWEEN '".$_REQUEST['start_date']."' AND '".$_REQUEST['end_date']."'
				AND spv.UserId like '%".$_REQUEST['spv']."%'
				AND (agt.UserId like '%".$_REQUEST['agt']."%' or agt.UserId is null)
...
<legend style="color: teal;"> &nbsp;&nbsp;&nbsp;Download RCT (Per Team)&nbsp;&nbsp;&nbsp;</legend>
