...
<legend style="color: teal;"> &nbsp;&nbsp;&nbsp;Download RCT (Per Team - Closing QA)&nbsp;&nbsp;&nbsp;</legend>
...
<tbody>
	<?php
		...
		while($row = $db ->fetchrow($ListPages->result)){
			...
			$totalInterested [$row -> spvid] =(($row -> Interested)+($row ->InterestedWithSpouse));
			...
			$AVG [$row -> spvid] =  $anp_cnt[$row->spvid] / $pif [$row -> spvid] / 12;
			...
			$Tots_sp+=$cnt_sp[$row->spvid];
			$Tots_dp+=$cnt_dp[$row->spvid];
	...
	?>
			...
			<tr>
				...
				<td nowrap style="text-align: center" class="content-middle"><?php echo $cnt_sp[$row->spvid];?></td>
				<td nowrap style="text-align: center" class="content-middle"><?php echo $cnt_dp[$row->spvid];?></td>
				...
				<td nowrap style="text-align: center" class="content-middle"><?php echo $anp_cnt[$row->spvid];?></td>
				<td nowrap style="text-align: center" class="content-middle"><?php echo number_format($AVG [$row -> spvid],2);?></td>
			</tr>
