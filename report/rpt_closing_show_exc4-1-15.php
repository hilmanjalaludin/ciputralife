...
<thead>
	...
	<tr height="30">
		...
		<th nowrap bgcolor="#3366FF" class="custom-grid th-middle" style="color:#FFFFFF;text-align:center;">&nbsp;HolderId</th>
		<th nowrap bgcolor="#3366FF" class="custom-grid th-middle" style="color:#FFFFFF;text-align:center;">&nbsp;tittle</th>
...
<tbody>
	...
	<div id="rpt_top_content" class="box-shadow" style="width:1115px;height:auto;overflow:auto;">
		<tr>
			...
			<td nowrap style="text-align: center" class="content-middle"><?php echo $row ->title; ?></td>
