...
<body>
	<fieldset class="corner">
		<legend class="icon-product" style="color: teal;"> &nbsp;&nbsp;&nbsp;Summary FreePA &nbsp;&nbsp;&nbsp;</legend>
		<legend style="color: #637dde;">
			<?php
				echo "<th> &nbsp;&nbsp;&nbsp;Monitoring Start Date &nbsp;: $start_date </th>";
				echo "<th> &nbsp;&nbsp;&nbsp;- </th>";
				echo "<th> &nbsp;&nbsp;&nbsp;Monitoring End Date  &nbsp;: $end_date<br/></th>";
				echo "</br>";
		...
		echo "<table class=\"grid\" cellpadding=\"0\" cellspacing=\"0\" >
				<tr>
					...
					<td class=\"header first\" nowrap align=\"center\">ProspectId</td>
					<td class=\"header first\" nowrap align=\"center\">Policy</td>
					...
					<td class=\"header first\" nowrap align=\"center\">Gender</td>
					<td class=\"header first\" nowrap align=\"center\">Age</td>
					<td class=\"header first\" nowrap align=\"center\">Expired</td>
					<td class=\"header first\" nowrap align=\"center\">No. Induk </td>
					<td class=\"header first\" nowrap align=\"center\">No. Polis</td>
					<td class=\"header first\" nowrap align=\"center\">Source</td>
					<td class=\"header first\" nowrap align=\"center\">Created</td>
					<td class=\"header first\" nowrap align=\"center\">Updated</td>
					<td class=\"header first\" nowrap align=\"center\">Remark1</td>
