...
?> 
	...
	<script>
		function ShowReport($csCode){
			...
			rptver	='clsbyagt';
				var url  = "../report/rpt_closing_show_agt.php?action=ShowReport&start_date="+start_date+
				"&end_date="+end_date+
				"&prodid="+prodid+
				"&Campaign="+Campaign+
				"&exported="+exported+
		...
		function GetReport($csCode){
			...
			// 	return;
						...
						doJava.File = "../report/rpt_closing_download_agt.php";
						doJava.Params = {
	...
	<fieldset class="corner">
		<legend class="icon-product"> &nbsp;&nbsp;&nbsp;Form TXT File</legend>
						...
						<td>
							<table align="top" height="100%" width="50%" border="0">
									...
									<tr>
										...
										<td><a href="javascript:void(0);"  class="sbutton" onclick="GetReport();"><span>&nbsp;Download </span></a>	</td>
									</tr>
