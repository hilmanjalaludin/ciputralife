...
if (!define('Host', '192.168.16.252')) define('Host', '192.168.16.252');
if (!define('User', 'enigma')) define('User', 'enigma');
if (!define('Password', 'enigma')) define('Password', 'enigma');
if (!define('Database', 'ciputralifedb')) define('Database', 'ciputralifedb');
if (!define('Driver', 'mysql')) define('Driver', 'mysql');

/** define user level system **/
if (!define('USER_ROOT', 9)) define('USER_ROOT', 9);
if (!define('USER_ADMIN', 8)) define('USER_ADMIN', 8);
if (!define('USER_ACCMANAGER', 1)) define('USER_ACCMANAGER', 1);
