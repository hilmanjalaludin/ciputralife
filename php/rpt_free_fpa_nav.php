...
require(dirname(__FILE__)."/../sisipan/parameters.php");
	...
	$report_type = array (
			...
			'free_fpa' => 'Report Free FPA',
			'freepa_detail' => 'Report Free PA Detail'
			);
class rpt_free_fpa extends mysql {
	function getspv() {
		$datas = array();
...
var ShowHTML  = function ()
{
	var dialog = Ext.Window({
            url: '../report/index.html.free_fpa.php',
            ...
            param: {
                ...
                Option : Ext.Cmp('cmp_status').getValue(),
...
<fieldset class="corner" style="background-color:#FFFFFF;">
	<legend class="icon-menulist">&nbsp;&nbsp;Report Free FPA</legend>
	<div id="span_top_nav">
		<table cellpadding="4px">
			...
			<tr>
				...
				<tr>
					<td style="font-size:12px;padding-right:12px;font-family:Arial;color:red;text-align:right;"> *FreePA Option</td>
					<td><?php $jpForm->jpCombo('cmp_status','xx004', array(0=>"Nett",1=>"Gross"),NULL,0,0);?></td>
				</tr>
				<tr>
