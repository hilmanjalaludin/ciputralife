...
<fieldset class="corner">
	<legend class="icon-product"> &nbsp;&nbsp;&nbsp;Follow Up Fa Report</legend>
		<div id="cmp_top_content" class="box-shadow" style="margin-left:7px;width:1100px;height:auto;overflow:auto;padding:9px;margin-bottom:10px;">
			<table cellpadding="4px">
				<tr>
					<td style="font-size:12px;padding-right:12px;font-family:Arial;color:red;text-align:right;"> * Follow Up FA Type</td>
					<td><?php $jpForm->jpCombo('product_group','xx004', array('FA','TNA','MTF'));?></td>
				</tr>	
				<tr>
