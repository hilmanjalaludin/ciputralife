...
/** get info data **/
    ...
    if( $db -> getSession('handling_type') == 5) 
        $filter .= " AND a.FuQAStatus = 0 AND a.FuType= '1' AND a.IsForm = '1'";
	if(	$db -> getSession('handling_type') == 10) 
		$filter .= " AND e.ApproveId = 16  AND a.FuType = '1' AND a.IsForm = '1'";
...
<tbody>
	...
	?>
			<tr class="onselect" bgcolor="<?php echo $color;?>">
				...
				<input _data_="<?php echo $row -> FuId; ?>"  type="checkbox" value="<?php echo $row -> CustomerId; ?>" name="chk_cust_call" name="chk_cust_call"></td>
				<!--<input type="checkbox" value="<?php// echo $row -> FuId; ?>" name="chk_cust_call" name="chk_cust_call"></td>-->
				<td class="content-middle"><?php  echo $no; ?></td>
				<td class="content-middle"><?php  echo $row -> CampaignName; ?></div></td>
