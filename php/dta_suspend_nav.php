...
?>
	...
	/* assign navigation filter **/
		...
		var navigation = {
			custnav:'dta_suspend_nav.php',
			custlist:'dta_suspend_list.php'
		}
	...
	/* creete object javaclass **/
		...
		doJava.File = '../class/class.src.suspend.php'; 
	...
	/* function clear searching form **/	
		...
		var CallProspect=function()
		{
			var arrCallRows  = doJava.checkedValue('chk_cust_suspend');
			var arrCountRows = arrCallRows.split(','); 
			if( arrCallRows!='')
			{
				if( arrCountRows.length == 1 )
				{
					doJava.File = 'dta_suspend_detail.php';
 ...
 /* go to call contact detail customers **/
	...
	/* memanggil Jquery plug in */
		...
		$(function(){
			...
			$('#toolbars').extToolbars({
				extUrl   :'../gambar/icon',
				extTitle :[['Search'],['Call Prospect'],['Clear']],
				extMenu  :[['searchCustomer'],['CallProspect'],['resetSeacrh']],
				extIcon  :[['zoom.png'],['phone.png'],['cancel.png']],
				extText  :true,
				extInput :true,
				extOption:[{
						render : 4,
	...
	<!-- start : content -->
		...
		<fieldset class="corner">
			<legend class="icon-customers">&nbsp;&nbsp;Customer Suspend Selling </legend>	
