...
//////////////////////////////////////////////////////////////
	...
	// doJava.dom("alloc_data_size").addEventListener("keyup", function(e) {
		// var total_data =  parseInt(e.currentTarget.value);
	// });
...
//////////////////////////////////////////////////////////////
	...
	{
		doJava.File = "../class/class.calleddata.php";
		doJava.Params = {
...
//////////////////////////////////////////////////////////////
	...
	var Find = function()
	{
		...
		var CallReasonId = doJava.SelArrVal('CallReasonId');
...
<fieldset class="corner" style="background-color:#FFFFFF;">
	<legend class="icon-menulist">&nbsp;&nbsp;Re-Assignment Data </legend>	
	<div class="box-shadow">
		<table cellpadding="8px;" width="75%" style="margin-top:5px;margin-bottom:5px;" border=0>
			<tr>
				<td class="text_header" rowspan=3 valign="top" nowrap> Campaign</td>
				<td valign="top" rowspan=3><?php $jpForm ->jpMultiple('CampaignId', 'select_multiple', getListCampaign());?></td>
				<td class="text_header" rowspan=3 valign="top" nowrap> Call Result</td>
				<td valign="top" rowspan=3><?php $jpForm ->jpMultiple('CallReasonId', 'select_multiple', getListReason());?></td>
				<td class="text_header" valign="top" nowrap>From AM </td>
				<td valign="top"> <?php $jpForm -> jpCombo('FromMgrId', 'select', getListMgr(),$_SESSION['mgr_id'],'onChange="AgentByMgr(this);"');?>  </td>
				<td class="text_header" valign="top" nowrap>To AM </td>
				<td valign="top"> <?php $jpForm -> jpCombo('ToMgrId', 'select', getListToMgr(),$_SESSION['mgr_id'],'onChange="ToAgentByMgr(this);"');?>  </td>
			</tr>
			<tr>
				<td class="text_header" valign="top" nowrap>From SPV </td>
				<td valign="top"> <div id="dSPVId"> <?php $jpForm -> jpCombo('FromSupervisorId', 'select', getListSpv(),$_SESSION['spv_id'],'onChange="AgentBySpv(this);"');?></div></td>
				
				<td class="text_header" valign="top" nowrap>To SPV </td>
				<td valign="top"> <div id="toSPVId"> <?php $jpForm -> jpCombo('ToSupervisorId', 'select', getListToSpv(),$_SESSION['spv_id'],'onChange="ToAgentBySpv(this);"');?></div></td>
			</tr>
