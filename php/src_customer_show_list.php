...
/** get status closing ****/
 ...
 /** create set filter SQL if found **/	
    ...
    $filter.= " order by CustomerUpdatedTs asc";
	...
	<?php
		...
		while($row = $db ->fetchrow($ListPages->result)){
			...
			<tr class="onselect">
				...
				<td class="content-first" width='5%'><input type="checkbox" value="<?php echo $row -> CustomerId."_".$row -> CampaignId."_".$row -> CallReasonId; ?>" name="chk_cust_call" name="chk_cust_call"  ></td>
