...
?>
	...
	/* assign navigation filter **/
		...
		var navigation = {
			custnav:'dta_spv_nav.php',
			custlist:'dta_spv_list.php'
		}
	...
	/* creete object javaclass **/
		...
		doJava.File = '../class/class.src.supervisor.php'; 
 ...
 /* go to call contact detail customers **/
			...
			var arrCountRows = arrCallRows.split(','); 
				...
				{	
					if( arrCountRows.length == 1 )
					{
						...
						if( (arrCallRows[2]=='39') || (arrCallRows[2]=='40'))
						{
						
							doJava.File = 'dta_spv_detail.php';
							doJava.Params = {
								CustomerId : arrCallRows[0],
								CampaignId : arrCallRows[1]
							}
							
							$('#main_content').load(doJava.File+'?'+doJava.ArrVal());
							//extendsJQuery.contactDetail(,arrCallRows[1])
						}
						else{
	...
	/* memanggil Jquery plug in */
		...
		$(function(){
			...
			$('#toolbars').extToolbars({
				extUrl   :'../gambar/icon',
				extTitle :[['Search'],['Confirm Policy '],['Clear']],
				extMenu  :[['searchCustomer'],['showPolicy'],['resetSeacrh']],
				extIcon  :[['zoom.png'],['aux-p.png'],['cancel.png']],
				extText  :true,
				extInput :true,
				extOption:[{
						render : 4,
	...
	<!-- start : content -->
		...
		<fieldset class="corner">
			<legend class="icon-customers">&nbsp;&nbsp;Pending Confirmation </legend>	
