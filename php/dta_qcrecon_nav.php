...
/** not valid page if not serachc **/
 ...
 /** set filter **/
	...
	$filter =  " AND b.AssignAdmin is not null 
				 ...
				 AND a.CallReasonQue IN(2) "; //13,".$db -> Entity -> VerifiedConfirm().")";
				 //AND b.AssignBlock=0
...
?>
	...
	/* assign navigation filter **/
		...
		var navigation = {
			custnav:'dta_qcrecon_nav.php',
			custlist:'dta_qcrecon_list.php'
		}
 ...
 /* go to call contact detail customers **/
			...
			var arrCountRows = arrCallRows.split(','); 
				...
				{	
					if( arrCountRows.length == 1 )
					{
						...
						{
							doJava.File = 'dta_qcrecon_detail.php';
	...
	<!-- start : content -->
		...
		<fieldset class="corner">
			<legend class="icon-customers">&nbsp;&nbsp;Reconfirm Menu</legend>	
