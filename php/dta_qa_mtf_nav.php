...
/** set general query SQL ****/
    ...
    if( $db -> getSession('handling_type') == 5) 
        $filter .=" AND a.FuType = '3' AND a.FuQAStatus = '0' AND a.IsForm = '1'";
	if( $db ->getSession('handling_type') == 10)
		$filter.="AND e.ApproveId = '22' AND a.FuType = '3' AND a.IsForm = '1'";
...
?>
	...
	/* assign navigation filter **/
		var navigation = {
			custnav  : 'dta_qa_mtf_nav.php',
			custlist : 'dta_qa_mtf_list.php'
		}
			...
			var arrCountRows = arrCallRows.split(','); 
				...
				{	
					if( arrCountRows.length == 1 )
					{
						...
						{
							doJava.File = 'dta_qa_mtf_detail.php';
							doJava.Params = { 
