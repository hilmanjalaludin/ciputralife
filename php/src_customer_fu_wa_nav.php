...
?>
	...
	/* assign navigation filter **/
		...
		var navigation = {
			custnav:'src_customer_fu_wa_nav.php',
			custlist:'src_customer_fu_wa_list.php'
		}
				...
				{	
					if( arrCountRows.length == 1 )
					{
						...
						if( (arrCallRows.length==4))
						{
							...
							// alert(CustomerId+" -- "+CampaignId+"--"+CallReasonId+"--"+VerifiedStatus);
							extendsJQuery.verifiedWaContent(CustomerId, CampaignId, VerifiedStatus)
						}
						else{
