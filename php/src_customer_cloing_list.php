<?php
 ...
 /** set  genral query SQL  **/
	...
	$sql = "SELECT 
				a.CustomerId, a.CallReasonId,
				a.CampaignId, a.CustomerNumber, 
				a.CustomerFirstName, a.CustomerLastName, 
				a.CustomerHomePhoneNum, a.CustomerMobilePhoneNum,
 ...
 /** create set filter SQL if found **/	
	...
	/*if( isset($_SESSION['V_CMP']))
		$filter.=" AND a.CampaignId =".$_SESSION['V_CMP'];	*/
...
<thead>
	<tr height="20"> 
		...
		<!--<th nowrap class="custom-grid th-middle">&nbsp;Fin Number</th>-->
...
<tbody>
	...
	?>
			<tr class="onselect">
				...
				<input type="checkbox" value="<?php echo $row -> CustomerId."_".$row -> CampaignId."_".$row -> CallReasonId; ?>" name="chk_cust_call" name="chk_cust_call" 
					<?php echo ($db->getSession('handling_type')!=4?'disabled':'');?> ></td>
