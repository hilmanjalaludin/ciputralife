...
<thead>
	<tr height="20"> 
        ...
        <th nowrap class="custom-grid th-middle">&nbsp;<span class="header_order" onclick="extendsJQuery.orderBy('tgsc.AproveName');"><b style='color:#608ba9;'>Verify Status</b></span></th>
