<?
	...
	/** create object **/
		...
		$sql = " SELECT 
					LastCallId, LastCallStartDate, LastCallEndDate,LastCallReason,
					LastCallStartTime, LastCallEndTime, IF(LastCallStatus<>0,'Active','Not Active') as LastCallStatus, 
					LasCallCreateBy, LastCallCreateDate,
					b.id, b.full_name 
...
<tbody>
	...
	?>
			<tr CLASS="onselect" bgcolor="<?php echo $color;?>">
				...
				<td nowrap class="content-middle" style="padding:3px;"><?php echo $db -> Date -> indonesia($row -> LastCallStartDate); ?></td>
				<td nowrap class="content-middle" style="padding:3px;"><?php echo $db -> Date -> indonesia($row -> LastCallEndDate); ?></td>
				...
				<td nowrap class="content-middle" style="padding:3px;"><?php echo $db -> Date -> date_time_indonesia($row -> LastCallCreateDate); ?></td>
