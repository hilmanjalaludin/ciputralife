...
/** custom filtering data **/
	...
	//$filter.= " order by CustomerUpdatedTs asc limit 1";	
...
?>
	...
	/* create object **/
	 ...
	 var kelas	= '../class/class.src.customers_show.php'
	 var datas  = {}
	...
	/* assign navigation filter **/
		...
		var navigation = {
			custnav:'src_customer_show_nav.php',
			custlist:'src_customer_show_list.php'
		}
