<?php
 ...
 /** get Call status list **/
	...
	{
		global $db;
		$sql = "select a.CallReasonId, a.CallReasonCode, a.CallReasonDesc from t_lk_callreason a  where a.CallReasonStatusFlag=1  and a.CallReasonEvent =1
...
?>
	...
	/* assign navigation filter **/
		...
		var navigation = {
			custnav:'src_customer_closing_nav.php',
			custlist:'src_customer_closing_list.php'
		}
	...
	/* creete object javaclass **/
		...
		doJava.File = '../class/class.src.customer_closing.php' 
 ...
 /* go to call contact detail customers **/
	...
	/* memanggil Jquery plug in */
		...
		$(function(){
			...
			$('#toolbars').extToolbars({
				extUrl   :'../gambar/icon',
				extTitle :[['Search'],['Go to Call '],['Show Policy'],['Clear']],
				extMenu  :[['searchCustomer'],['gotoCallCustomer'],['ShowPolicy'],['resetSeacrh']],
				extIcon  :[['zoom.png'],['telephone_go.png'],['application_form_magnify.png'],['cancel.png']],
				extText  :true,
				extInput :true,
				extOption:[{
						render : 4,
	...
	<!-- start : content -->
		...
		<fieldset class="corner">
			<legend class="icon-customers">&nbsp;&nbsp;Customer Closing </legend>	
