	...
	<div id="pages">
		<table border=0 cellpadding=4 cellspacing=0 width="90%" align="center" class="form">
			...
			<tr height=20>
			  ...
			  <td class="content"><?php echo $jpForm-> jpField('customer_dob','inputtext',$Customers['PolicySalesDate'],NULL,1);?></span></td>
			</tr>
			...
			<tr height=20 >
			  ...
			  <td class="content"><?php echo $jpForm-> jpField('customer_dob','inputtext',$Customers['CustomerDOB'],NULL,1,10);?></td>
			</tr>
			<!--
			<tr height=20>
			  <td class="header" >Customer Name</td>
