...
<thead>
	<tr height="20"> 
		...
		<th nowrap class="custom-grid th-middle">&nbsp;From Value Number</th>
		<th nowrap class="custom-grid th-middle">&nbsp;To Value Number</th>
		<th nowrap class="custom-grid th-middle">&nbsp;Is Phone Type </th>
...
<tbody>
	...
	?>
			<tr CLASS="onselect">
				<td class="content-first"><input type="checkbox" value="<?php echo $row -> ApprovalHistoryId; ?>" name="chk_apprv" id="chk_apprv"></td>
				...
				<td class="content-middle"><?php echo $row -> PhoneDesc; ?></td>
				<td class="content-middle"><?php echo $db -> Date->date_time_indonesia($row -> ApprovalCreatedTs); ?></td>
